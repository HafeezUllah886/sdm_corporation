                        ...
                        <div class="col-lg-12">
                            <div class="card-body p-4">
                                <div class="row g-3">
                                    ...
                                    <div class="col-lg-3 col-6">
                                        <p class="text-muted mb-2 text-uppercase fw-semibold">Town</p>
                                        <h5 class="fs-14 mb-0">{{ $town->name }}</h5>
                                    </div>
                                    <!--end col-->
                                    <!--end col-->
                                    <div class="col-lg-3 col-6">
                                    ...
                                    <table class="table table-borderless text-center table-nowrap align-middle mb-0" id="buttons-datatables">
                                        ...
                                        <tfoot>
                                            <tr>
                                                ...
                                                <th class="text-end">{{number_format($products->sum('amount'), 2)}}</th>
                                            </tr>
                                        </tfoot>
                                    </table><!--end table-->
                                </div>
